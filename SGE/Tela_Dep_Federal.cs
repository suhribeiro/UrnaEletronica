...
namespace SGE
{
    public partial class Tela_Dep_Federal : Form
    {
        private DepFederal dep_Fed = new DepFederal();
        ...
        public Tela_Dep_Federal(string val)
        {
            uf.CadastraEstados();
        ...
        public string String_Conc4
        {
            get { return string_Conc4; }
            set { string_Conc4 = value; }
        }
        ...
        public void Converte()
        {
            ...
            String_Conc4 = String.Concat(List_String_Cand);
            Num_Cand_Conv = Convert.ToInt32(String_Conc4);
        ...
        public void Mostra()
        {
            ...
            {
                listas.Carrega_Dep_Federal();                                      //Carrega a lista de candidatos a Dep. Estadual

                foreach (var x in listas.List_DepFederal)                         //Verifica se na lista de Dep. Federais cadastrados existe o número digitado pelo eleitor.
                {
                ...
                if (achouCandidato == false)                                        //Se não encontrar candidato
                {
                    ...
                    if (((Num_Part_Conv == Partido.Cod) && (List_String_Cand.Count == 4)))
                    {
                        timer7.Enabled = false;
                        timer6.Enabled = false;
                        timer9.Enabled = false;
                ...
                else
                {
                    ...
                    if (((Num_Cand_Conv == Dep_Fed.Num) && (List_String_Cand.Count == 4)))
                    {
                        timer6.Enabled = false;
                        timer7.Enabled = false;
                        timer8.Enabled = false;
                        timer9.Enabled = false;
                        Esconde_Camp();
                        camp_nome_candid.Text = Dep_Fed.NomeUrna;
                        camp_nome_part.Text = Dep_Fed.Part.Abrev;
                        camp_image.BackgroundImage = dep_Fed.BuscaImagem(dep_Fed.Num, dep_Fed.Uf, "Federal");
                        camp_aperte_tec.Visible = true;
